            ...
            if ($firstLine === false || $firstLine === null) {
                ...
                if ($headers !== $expectedHeaders) {
                    ...
                    while (($row = fgetcsv($handle, 1000, ',')) !== false) {
                        ...
                        if (!is_numeric($temp)     || $temp < -90     || $temp > 60) {
                            $errors++;
                            continue;
                        }
    ...
    <section>
        ...
        <?php if ($importReport): ?>
            ...
            <table border="1">
                <tr>
                    <td>Fichier</td>
                    <td><?= htmlspecialchars($importReport['file'])     ?></td>
                </tr>
                <tr>
                    <td>Total lignes</td>
                    <td><?= $importReport['total']    ?></td>
                </tr>
                <tr>
                    <td>Insérées</td>
                    <td><?= $importReport['inserted'] ?></td>
                </tr>
                <tr>
                    <td>Erreurs</td>
                    <td><?= $importReport['errors']   ?></td>
                </tr>
                <tr>
                    <td>Ignorées</td>
                    <td><?= $importReport['skipped']  ?></td>
                </tr>
            </table>
        <?php endif; ?>
